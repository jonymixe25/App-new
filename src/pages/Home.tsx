...
import { Video, MonitorPlay, Mountain, CloudFog } from "lucide-react";
    ...
    <div className="min-h-screen bg-stone-900 text-stone-50 flex flex-col font-sans">
      ...
      <div className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-b from-stone-900/30 via-stone-900/60 to-stone-900"></div>
        </div>
        
        <div className="relative z-10 text-center space-y-6 px-4 max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-900/40 border border-emerald-500/30 text-emerald-200 backdrop-blur-sm mb-4">
          ...
          <p className="text-xl md:text-2xl text-stone-200 max-w-2xl mx-auto font-light leading-relaxed">
            Conectando a la comunidad Ayuuk con el mundo. Transmisiones en vivo desde el corazón de la sierra.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
            ...
            <Link
              to="/admin"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-stone-800/80 hover:bg-stone-700 text-stone-200 font-medium rounded-full border border-stone-600 backdrop-blur-sm transition-all hover:scale-105"
            >
